// [object Object] - Thinkful - Number Drills: Pixelart planning  [ ID: 58630e2ae88af44d2b0000ea  (thinkful-number-drills-pixelart-planning) ]
...
describe("Random tests", () =>{
  ...
  for (let i=0;i<40;i++){
    const w=randint(500, 11000),p=randint(2,29);
