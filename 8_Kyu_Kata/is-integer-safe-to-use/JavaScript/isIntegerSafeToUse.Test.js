// [object Object] - Is integer safe to use?  [ ID: 55a4f9afeffe4231090000d6  (is-integer-safe-to-use) ]
...
for (let i=0;i<200;i++) {
  ...
  Test.assertEquals(SafeInteger(randInt), isSafe(randInt), 
        'Value returned should be ' + isSafe(randInt));
}
  });
});
