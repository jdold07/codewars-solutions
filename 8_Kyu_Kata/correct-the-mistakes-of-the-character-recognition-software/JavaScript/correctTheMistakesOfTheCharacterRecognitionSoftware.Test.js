// [object Object] - Correct the mistakes of the character recognition software  [ ID: 577bd026df78c19bca0002c0  (correct-the-mistakes-of-the-character-recognition-software) ]
...
describe("More test cases",function(){
  it("Testing for fixed tests", () => {
    ...
    assert.strictEqual(correct("R1CHARD P. FEYNMAN - THE FEYNMAN LECTURE5 0N PHY51C5"),"RICHARD P. FEYNMAN - THE FEYNMAN LECTURES ON PHYSICS");
    ...
    assert.strictEqual(correct("5TEPHEN HAWK1NG - THE UN1VER5E 1N A NUT5HELL"),"STEPHEN HAWKING - THE UNIVERSE IN A NUTSHELL");
    ...
    assert.strictEqual(correct("J. K. R0WL1NG - HARRY P0TTER AND THE PH1L050PHER'5 5T0NE"),"J. K. ROWLING - HARRY POTTER AND THE PHILOSOPHER'S STONE");
    assert.strictEqual(correct("J. K. R0WL1NG - HARRY P0TTER AND THE CHAMBER 0F 5ECRET5"),"J. K. ROWLING - HARRY POTTER AND THE CHAMBER OF SECRETS");
    assert.strictEqual(correct("J. K. R0WL1NG - HARRY P0TTER AND THE PR150NER 0F Azkaban"),"J. K. ROWLING - HARRY POTTER AND THE PRISONER OF Azkaban");
    assert.strictEqual(correct("J. K. R0WL1NG - HARRY P0TTER AND THE G0BLET 0F F1RE"),"J. K. ROWLING - HARRY POTTER AND THE GOBLET OF FIRE");
    assert.strictEqual(correct("J. K. R0WL1NG - HARRY P0TTER AND THE 0RDER 0F PH0EN1X"),"J. K. ROWLING - HARRY POTTER AND THE ORDER OF PHOENIX");
    assert.strictEqual(correct("J. K. R0WL1NG - HARRY P0TTER AND THE HALF-BL00D PR1NCE"),"J. K. ROWLING - HARRY POTTER AND THE HALF-BLOOD PRINCE");
    assert.strictEqual(correct("J. K. R0WL1NG - HARRY P0TTER AND THE DEATHLY HALL0W5"),"J. K. ROWLING - HARRY POTTER AND THE DEATHLY HALLOWS");
