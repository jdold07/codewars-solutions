// [object Object] - ES6 string addition  [ ID: 582e4c3406e37fcc770001ad  (es6-string-addition) ]
...
describe("add", () => {
 ...
 it("Testing that the '+' operator, String.concat and Array.join() are not used", () => {
   ...
   Test.assertEquals(usercode.toString().includes('+'), false, "You cannot use the '+' operator, even outside of the joinString function!");
   Test.assertEquals(usercode.toString().includes('concat'), false, "You cannot use the String.concat() method, even outside of the joinString function!");
   Test.assertEquals(usercode.toString().includes('join('), false, "You cannot use the Array.join() method, even outside of the joinString function!");
