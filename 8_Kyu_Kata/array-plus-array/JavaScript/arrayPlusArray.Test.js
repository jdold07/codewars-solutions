// [object Object] - Array plus array  [ ID: 5a2be17aee1aaefe2a000151  (array-plus-array) ]
...
describe("Random tests", function(){
  ...
  it("Testing for 20 random tests", () => {
    for (let i = 0; i < 20; i++){
      ...
      assert.strictEqual(arrayPlusArray(arr1.slice(), arr2.slice()), check(arr1.slice(), arr2.slice()), `Testing for arrayPlusArray ([ ${arr1} ], [  ${arr2} ])`);
    }
  })
})
