// [object Object] - Improving Math.round(x)  [ ID: 56be025f9347a066c7000e4f  (improving-math-dot-round-x) ]
...
function rndto(n,p){return rnd(exponent(10,p)*n)/exponent(10,p)}
for (i = 0; i < 100; i++) {
