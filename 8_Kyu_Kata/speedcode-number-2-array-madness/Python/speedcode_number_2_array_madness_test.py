# [object Object] - SpeedCode #2 - Array Madness  [ ID: 56ff6a70e1a63ccdfa0001b1  (speedcode-number-2-array-madness) ]
...
def fixed_tests():
    ...
    def fixed_test():
        ...
        test.assert_equals(array_madness([2, 5, 3, 4, 1], [3, 3, 3, 3, 3]), False);
        test.assert_equals(array_madness([1, 3, 4, 2, 4], [2, 2, 2, 2, 2, 2, 2, 1]), False);
        test.assert_equals(array_madness([1, 2, 3, 4, 5], [2, 2, 2, 2, 2, 2, 1, 1, 1]), True);
        test.assert_equals(array_madness([2, 4, 6, 8, 10, 12, 14], [1, 3, 5, 7, 9, 11, 13]), False);
