// [object Object] - Find Maximum and Minimum Values of a List  [ ID: 577a98a6ae28071780000989  (find-maximum-and-minimum-values-of-a-list) ]
...
describe("Find Minimum and Maximum Values", function(){
  ...
  it("Random Tests", function(){
    for(let i = 0; i < 10; i++){
      let rand_lng = ~~(Math.random() *13)+1, rand_list = [];
