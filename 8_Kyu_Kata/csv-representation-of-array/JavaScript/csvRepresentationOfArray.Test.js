// [object Object] - CSV representation of array  [ ID: 5a34af40e1ce0eb1f5000036  (csv-representation-of-array) ]
...
describe("Random Tests", () => {
  ...
  for (let i = 1; i <= 97; i++){
    ...
    it(`Testing №${i + 3}`, () => {
      Test.assertEquals(toCsvText(array), expected, `It should work for random tests too`);
    })
    };
})
