// [object Object] - Basic Training: Add item to an Array  [ ID: 511f0fe64ae8683297000001  (basic-training-add-item-to-an-array) ]
...
describe("Checking Reference", () => {
  it("Should not create a new array", () => {
    assert.strictEqual(_websitesInternal, websites, "You assigned a new array to the websites variable. You should instead alter the existing reference.")
  })
})
