// [object Object] - Template Strings  [ ID: 55a14f75ceda999ced000048  (template-strings) ]
...
describe('Random tests', () => {
  let words = [['lives','people','you','objects','swings','leaders'],
            ['childish','avoidable','frozen','hard','objective']];
  for (let i3214 = 3; i3214 < 42; i3214++) {
    let rand1 = Math.floor(Math.random()*5), a = rand1;    
    let rand2 = Math.floor(Math.random()*5), b = rand2;
