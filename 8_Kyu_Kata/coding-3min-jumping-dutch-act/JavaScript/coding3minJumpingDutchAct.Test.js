// [object Object] - Coding 3min : Jumping Dutch act  [ ID: 570bcd9715944a2c8e000009  (coding-3min-jumping-dutch-act) ]
...
describe("<br><font size=6><b>-------- Coding 3min : Jumping Dutch act --------</b></font>", () => {
  ...
  it("<br><font size=4><b>--------Code length check --------</b></font>", () => {
    ...
    if (codelen<=limit) 
      assert.strictEqual("code length<="+limit,"code length>"+limit,  "your code length = "+codelen+", please try this code in challage version.\n the simple version only accept the solution which length>"+limit);
    else 
