// [object Object] - Safen User Input Part I - htmlspecialchars  [ ID: 56bcaedfcf6b7f2125001118  (safen-user-input-part-i-htmlspecialchars) ]
...
describe("Basic tests", () => {
  it("Simple tests", () => {
   ...
   it("Advanced tests", () => {
     const message = "<h2>Lorem Ipsum</h2>" + "\n" +
              ...
              "</script>";
     const safenedMessage = "&lt;h2&gt;Lorem Ipsum&lt;/h2&gt;" + "\n" +
              "&lt;p&gt;Lorem ipsum dolor sit amet, adispicing eu.&lt;/p&gt;" + "\n" +
              "&lt;p&gt;Lorem ipsum dolor sit amet, adispicing eu.&lt;/p&gt;" + "\n" +
              '&lt;p&gt;Hello Website Owner,&lt;br /&gt; I think you &amp; I can make an awesome &quot;hacking pair&quot;.  What do you think?&lt;/p&gt;' + "\n" +
              "&lt;script&gt;" + "\n" +
  ...
  it("Random tests", () => {
    ...
    const charsStr = ["&","<",">",'"','a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'].join`` + '&<>"'.repeat(20);
    ...
    for (let iterationVar = 0; iterationVar < 100; iterationVar++) {
      ...
      assert.strictEqual(htmlspecialchars(randomString), externalHTMLSpecialChars(randomString), `Testing for formData = ${JSON.stringify(randomString)}`);
    }
  })
})
