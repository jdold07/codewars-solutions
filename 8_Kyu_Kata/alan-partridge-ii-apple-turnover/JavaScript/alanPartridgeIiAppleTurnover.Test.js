// [object Object] - Alan Partridge II - Apple Turnover  [ ID: 580a094553bd9ec5d800007d  (alan-partridge-ii-apple-turnover) ]
...
describe("Alan Partridge II - Apple Turnover", () => {
  ...
  it("Random tests",() =>{
    ...
    function myapple(x){return Number(x)*Number(x)>1000?'It\'s hotter than the sun!!':'Help yourself to a honeycomb Yorkie for the glovebox.';}
