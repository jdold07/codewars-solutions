// [object Object] - Odd-Even String Sort  [ ID: 580755730b5a77650500010c  (odd-even-string-sort) ]
...
describe("Other Tests", function(){
  ...
  describe("More Complex Ones (random)", function(){
    ...
    for (let h = 0; h <= 20; h++) {
        ...
        let evenPredict = result[0], oddPredict = result[1];
        let res = sortMyString(S).split(' ');
        let evenExpect = res[0], oddExpect = res[1];
