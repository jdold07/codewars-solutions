// [object Object] - Cat and Mouse - Easy Version  [ ID: 57ee24e17b45eff6d6000164  (cat-and-mouse-easy-version) ]
...
describe("Cat and Mouse - Easy Version", () => {
  ...
  it("Random tests",() =>{
    ...
    function mycatMouse(x){return x.length<6?'Caught!':'Escaped!'}


    for (let i=0;i<200;i++){
      let x=['C'], len=randint(0,8);
