// [object Object] - GA-DE-RY-PO-LU-KI cypher  [ ID: 592a6ad46d6c5a62b600003f  (ga-de-ry-po-lu-ki-cypher) ]
...
function e(str) 
{
    ...
    return str.split("").map(x=> cypher.indexOf(x) == -1 ? x :
        ((cypher.indexOf(x) % 2 == 1) ? cypher[cypher.indexOf(x) - 1] : cypher[cypher.indexOf(x) + 1])).join("");
}
