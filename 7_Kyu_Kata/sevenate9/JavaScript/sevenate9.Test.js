// [object Object] - SevenAte9  [ ID: 559f44187fa851efad000087  (sevenate9) ]
...
describe('Fixed tests', () => {
  const tests = [['797', '77'], ['7979797', '7777'], ['165561786121789797', '16556178612178977'], ['16797', '1677'], ['77', '77'], ['7927', '7927'], ['1779', '1779'], ['a779', 'a779'], ['17797a', '1777a'], ['797 9 7', '77 9 7'], ['79799997', '7799997'], ['79', '79'], ['97', '97'], ['', '']];
...
describe('Random tests', () => {
  ...
  for (let i = 0; i < 40; i++) {
    const chars = Array.from({ length: randomInt(1, 8) }, () => {
      ...
      if (r < 0.50) return '7' + '97'.repeat(randomInt(1, 8));
