// [object Object] - SantaClausable Interface  [ ID: 52b50a20fa0e77b304000103  (santaclausable-interface) ]
...
describe('SantaClausable Interface', function() {
  var SantaClaus = (function() {
    function SantaClaus(name) { this.name = name; }
    SantaClaus.prototype.sayHoHoHo = function() { console.log(this.name + ' says: "Ho Ho Ho!"') };
    SantaClaus.prototype.distributeGifts = function() { console.log(this.name + ' hands out gifts to all the children'); };
    SantaClaus.prototype.goDownTheChimney = function() { console.log('*Whoosh* ' + this.name + ' goes down the chimney.'); };
    return SantaClaus;
  })();

  var DummySantaClaus = (function() {
    function DummySantaClaus() {};
    DummySantaClaus.prototype.sayHoHoHo = function() { throw 'Ho Ho Ho!'; };
    DummySantaClaus.prototype.distributeGifts = function() { throw 'Gifts for all!'; };
    DummySantaClaus.prototype.goDownTheChimney = function() { throw 'Whooosh!'; };
  ...
  var NotSantaClaus = (function() {
    function NotSantaClaus(name) { this.name = name; }
