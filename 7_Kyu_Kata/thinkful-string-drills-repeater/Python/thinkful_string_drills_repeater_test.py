# [object Object] - Thinkful - String Drills: Repeater  [ ID: 585a1a227cb58d8d740001c3  (thinkful-string-drills-repeater) ]
...
def more_tests():
    ...
    test.assert_equals(repeater('A stopped clock is right twice a day. ', 2), 'A stopped clock is right twice a day. A stopped clock is right twice a day. ')
