// [object Object] - Sort arrays - 1  [ ID: 51f41b98e8f176e70d0002a8  (sort-arrays-1) ]
...
describe("Random tests", () => {  
  ...
  for(let i = 0; i < 100; i++){
    let arr = Array.from({length: randint(3, 6)}, (_, i) => Array.from({length: randint(4, 10)}, (_, i) => s[randint(0, s.length - 1)]).join``)
