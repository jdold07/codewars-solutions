// [object Object] - Holiday III - Fire on the boat  [ ID: 57e8fba2f11c647abc000944  (holiday-iii-fire-on-the-boat) ]
...
describe("Holiday III - Fire on the boat", () => {
  ...
  it("Random tests",() =>{
    ...
    let names=["Fire", "Boat", "Hull", "Propeller", "Engine", "Sail", "Deck", "Fire", "Fire", "Mast", "Captain", "Rudder", "Fire", "Water"];
