// [object Object] - Jumping  Number (Special Numbers Series  #4)  [ ID: 5a54e796b3bfa8932c0000ed  (jumping-number-special-numbers-series-number-4) ]
...
const sol=n=>(n < 10 || Math.abs(n%10 - Math.floor(n%100/10)) == 1 && sol(Math.floor(n/10))=="Jumping!!") ? "Jumping!!" : "Not!!";
