# [object Object] - Flatten and sort an array  [ ID: 57ee99a16c8df7b02d00045f  (flatten-and-sort-an-array) ]
...
def fixed_tests():
    ...
    def basic_test_cases():
        ...
        test_flatten_and_sort([[111, 999], [222], [333], [444], [888], [777], [666], [555]], [111, 222, 333, 444, 555, 666, 777, 888, 999])
    ...
    def more_test_cases():
        ...
        test_flatten_and_sort([[], [], [64], [], [504, 503], [4096], [], [303], [202], [2500], [], [100]], [64, 100, 202, 303, 503, 504, 2500, 4096])
...
def random_tests():
    ...
    def unflatten_array(array, split_count):
        indexes = sorted(itertools.chain(
        (0, len(array)),
        (random.randrange(len(array) + 1) for _ in range(split_count))))
