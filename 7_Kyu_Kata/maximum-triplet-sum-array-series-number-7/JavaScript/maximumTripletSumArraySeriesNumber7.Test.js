// [object Object] - Maximum Triplet Sum (Array Series #7)   [ ID: 5aa1bcda373c2eb596000112  (maximum-triplet-sum-array-series-number-7) ]
...
describe("Basic tests", () => {
  ...
  it("Random tests",() =>{
    ...
    const sol=n=>Array.from(new Set(n)).sort((a,b)=>b-a).slice(0,3).reduce((a,b)=>a+b);

    for (let i=0;i<40;i++){
      const n=Array.from({length: randint(3,200)},_=>randint(-randint(1,Math.pow(10,randint(1,5))),randint(1,Math.pow(10,randint(1,5)))));
