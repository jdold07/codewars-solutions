// [object Object] - Thinkful - Object Drills: Quarks  [ ID: 5882b052bdeafec15e0000e6  (thinkful-object-drills-quarks) ]
...
describe("Random tests", () => {
  ...
  it("Tests", () => {
      while( x-- ){
        let c1 = rnd(colors), c2 = rnd(colors),
            f1 = rnd(flavors),f2 = rnd(flavors);
        let q1 = new Quark(c1, f1), q2 = new Quark(c2, f2);
