// [object Object] - Bumps in the Road  [ ID: 57ed30dde7728215300005fa  (bumps-in-the-road) ]
...
describe("Bumps in the Road", () => {
  ...
  it("Random tests",() =>{
    ...
    function mybump(x){return x.replace(/[^n]/g,'').length>15?'Car Dead':'Woohoo!';}
    let names=["n", "_"];

    for (let i=0;i<100;i++){
      let x=[], len=randint(1,35);
