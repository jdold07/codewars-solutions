...
def wrong_equation(eq):
      if not isinstance(eq, str): return eq   # Return non-string type input per instructions
      if eq == "": return "Empty!!"           # Return response to empty string input per instructions
      result = [eq]
