//+ ====================================================================================================================
//+
//+ 5 kyu - Regex Password Validation  [ ID: 52e1476c8147a7547a000811 ] (regex-password-validation)
...
describe("Tests suite", () => {
  it("REGEXP sould be a RegExp", () => {
    ...
    assert.strictEqual(REGEXP.test, RegExp.prototype.test)
  })
  ...
  function randPassword() {
    ...
    if (randInt(0, 1)) arrays.push(SYMBOLS)
    return Array.from({ length: randInt(0, 15) }, () => sample(sample(arrays))).join("")
  }

  const SOLUTION = /(?=.*\d)(?=.*[a-z])(?=.*[A-Z])^[a-zA-Z\d]{6,}$/
