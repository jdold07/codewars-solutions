# + =====================================================================================================================
# +
# + 8 kyu - Enumerable Magic #25 - Take the First N Elements  [ ID: 545afd0761aa4c3055001386 ] (enumerable-magic-number-25-take-the-first-n-elements)
...
from enumerable_magic_number_25_take_the_first_n_elements import take
...
def _():
    ...
    def generateRandomArray():
        ...
        arr = []
        for i in range(n):
            arr.append(int(math.floor(-100 * random.random() + 100 * random.random())))
        return arr
    ...
    for i in range(100):
        ...
        if len(arr) == 0:
            ...
            message = "should return 0 items"
        elif n <= len(arr):
            message = "should return the first " + str(n) + " items"
        else:
            message = (
                "should return the first "
                + str(len(arr))
                + " items (because there are no "
                + str(n)
                + " items in the array)"
            )
