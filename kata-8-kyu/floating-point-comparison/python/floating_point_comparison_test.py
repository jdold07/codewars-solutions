...
# + Category: BUG_FIXES  |  Tags: FUNDAMENTALS | MATHEMATICS | DEBUGGING
# +
# + =====================================================================================================================

import codewars_test as test
from floating_point_comparison import approx_equals
...
def random_tests():
    ...
    data = (
        [true_data() for _ in range(30)]
        + [false_data() for _ in range(30)]
        + [far_data() for _ in range(20)]
        + [round_data() for _ in range(20)]
    )
    shuffle(data)
