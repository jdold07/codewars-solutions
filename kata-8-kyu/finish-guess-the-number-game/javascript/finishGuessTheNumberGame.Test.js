...
const { Guesser } = require("./finishGuessTheNumberGame")
...
describe("Guesser", () => {
  ...
  it("Lives ran out should throw", () => {
    ...
    guesser.guess(1)
    guesser.guess(2)
    // assert.throws(guesser.guess(10), Error)
  })
    ...
    for (let i = 0; i < 10; ++i) {
      ...
      for (let j = 0; j < 20; ++j) {
        ...
        try {
          ...
          // assert.throws(guesser.guess(g), Error)
        }
      }
    }
  })
