//+ ====================================================================================================================
//+
//+ 8 kyu - String cleaning  [ ID: 57e1e61ba396b3727c000251 ] (string-cleaning)
...
const { stringClean } = require("./stringCleaning")
...
describe("String cleaning", () => {
  ...
  it("Random Tests", () => {
    ...
    let rnd = (x) => ~~(Math.random() * x),
      shuffle = (s) => _.shuffle([...s]).join("")

    let t = 10
    while (t--) {
      let exp = Array.from({ length: 2 + rnd(8) }, () => shuffle(VALIDS).slice(0, 1 + rnd(8))),
