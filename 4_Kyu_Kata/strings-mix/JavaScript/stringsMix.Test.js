// [object Object] - Strings Mix  [ ID: 5629db57620258aa9d000014  (strings-mix) ]
...
describe("Random tests",function() {
    ...
    function doEx() {
      ...
      var res = "";
      while (i < 30) {
        if (i % 5 === 0) var n = randint(35, 90); else n = randint(97, 122);
    ...
    for (var i = 0; i < 100; i++) {
        ...
        it("Testing Mixing: ", function() {
            Test.assertEquals(mix(s1, s2), mixSol(s1, s2),"It should work for random tests too")
        }
    )}
})
