...
describe("FizzBuzz++", function () {
  ...
  it("Should work for any coprimes", function () {
    Test.assertSimilar(fizzbuzzPlusPlus([2, 7, 15], ["a", "b", "c"]), ans([2, 7, 15], ["a", "b", "c"]))
  })

  it("Should work for duplicate words", function () {
    Test.assertSimilar(fizzbuzzPlusPlus([2, 7, 15], ["a", "a", "c"]), ans([2, 7, 15], ["a", "a", "c"]))
  })

  it("Should be efficient", function () {
    Test.assertSimilar(fizzbuzzPlusPlus([2, 3, 7, 19], ["a", "b", "c", "d"]), ans([2, 3, 7, 19], ["a", "b", "c", "d"]))
  })
