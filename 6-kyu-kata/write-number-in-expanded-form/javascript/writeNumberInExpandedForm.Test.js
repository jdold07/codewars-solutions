...
describe("Edge Cases", function() {
  ...
  it("Zeros", function(){
    Test.assertEquals(expandedForm(420370022), '400000000 + 20000000 + 300000 + 70000 + 20 + 2');
    Test.assertEquals(expandedForm(70304), '70000 + 300 + 4');
    Test.assertEquals(expandedForm(9000000), '9000000');
  });
  
  it("Big Numbers", function(){
    Test.assertEquals(expandedForm(92093403034573), '90000000000000 + 2000000000000 + 90000000000 + 3000000000 + 400000000 + 3000000 + 30000 + 4000 + 500 + 70 + 3');
    Test.assertEquals(expandedForm(2096039485293), '2000000000000 + 90000000000 + 6000000000 + 30000000 + 9000000 + 400000 + 80000 + 5000 + 200 + 90 + 3');
  });
