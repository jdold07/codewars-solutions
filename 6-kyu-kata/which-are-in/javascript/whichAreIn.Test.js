...
describe("Some random test:", function(){
  ...
  your opinion, what is the best reference for Ruby, updated to 1.9?".split(/\s+/)

  vv = ["1.9", "ou", "ve", "ect", "omm", "gla", "oint", "pini", "wh", "oes", "by", "ion", "or", "he", "ple", "ing"]
  
  var sample = function(aa,x){
    return Test.randomize(aa).slice(0,x)
  }
  
  var __in__array__ = function(aa,bb){ return aa.filter( function(a){ return bb.some( function(b){ return b.indexOf(a) >-1 } ) }) }

  Test.randomize([1,2,3,4,5,6,7,8,9]).forEach( function(x){
    var arr1 = sample(vv,x+1), arr2 = sample(uu,15+x*2), exp = __in__array__(arr1,arr2).sort(); 
