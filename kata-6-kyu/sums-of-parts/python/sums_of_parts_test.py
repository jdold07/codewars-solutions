...
def fixed_tests():
    ...
    def basic_tests():
        ...
        dotest(
            [30350, 76431, 156228, 78043, 98977, 80169, 32457, 182875, 162323, 17508, 57971, 171907],
            [1145239, 1114889, 1038458, 882230, 804187, 705210, 625041, 592584, 409709, 247386, 229878, 171907, 0],
        )

        dotest(
            [158077, 143494, 196531, 26272, 35656, 68756, 109861, 36958, 83895, 134127, 81618, 193758, 143422],
            [1412425, 1254348, 1110854, 914323, 888051, 852395, 783639, 673778, 636820, 552925, 418798, 337180, 143422, 0],
        )

        dotest(
            [3222, 77013, 124436, 117798, 28186, 183610, 121600, 20879, 44142, 23446, 154918, 54969, 94492],
            [1048711, 1045489, 968476, 844040, 726242, 698056, 514446, 392846, 371967, 327825, 304379, 149461, 94492, 0],
        )

        dotest(
            [170110, 139570, 171544, 71770, 167818, 133006, 33628, 81872, 3143, 136857, 70720, 122107, 91191, 80135],
            [
                1473471,
                1303361,
                1163791,
        ...
        dotest(
            [14231, 137542, 173347, 19792, 63830, 87040, 15621, 56268, 65441, 193264, 153828, 97321, 179116, 182144],
            [
                1438785,
                1424554,
                1287012,
        ...
        dotest(
            [129494, 8661, 83278, 157882, 71700, 176108, 140992, 46034, 43763, 33163, 11459, 30943, 27364, 44541, 166148],
            [
                1171530,
                1042036,
                1033375,
        ...
        dotest(
            [7461, 88792, 18254, 13036, 187505, 49921, 48327, 169546, 163058, 187330, 160768, 165043, 35777, 140508, 147381],
            [
                1582707,
                1575246,
                1486454,
...
def random_tests():
    ...
    def random_tests_():
        i = 0
        while i < 50:
            a = randint(10000, 60000)
            ls = do_ex(a)
            sol = parts_sums_hy(ls)
            test.assert_equals(parts_sums(ls), sol)
            i += 1
