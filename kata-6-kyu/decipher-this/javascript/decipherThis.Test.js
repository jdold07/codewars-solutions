...
it("Basic Tests", () => {
  assert.strictEqual(decipherThis("65 119esi 111dl 111lw 108dvei 105n 97n 111ka"), "A wise old owl lived in an oak")

  assert.strictEqual(decipherThis("84eh 109ero 104e 115wa 116eh 108sse 104e 115eokp"), "The more he saw the less he spoke")

  assert.strictEqual(
    decipherThis("84eh 108sse 104e 115eokp 116eh 109ero 104e 104dare"),
  ...
  assert.strictEqual(decipherThis("84kanh 121uo 80roti 102ro 97ll 121ruo 104ple"), "Thank you Piotr for all your help")
})
...
it("Random Tests", function () {
  ...
  for (let i = 0; i < 100; i++) {
    ...
    assert.strictEqual(decipherThis(randomCipher), decipherThisSolution(randomCipher))
  }
})
