...
const { step } = require("./stepsInPrimes")
...
describe("Random tests", function () {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    it("Testing Step: ", function () {
      ...
      let k = randint(0, 2)
      if (k % 2 === 0) assert.deepEqual(step(2, n + 1000, n + 10000), stepSol(2, n + 1000, n + 10000))
      else assert.deepEqual(step(4, n + 1000, n + 10000), stepSol(4, n + 1000, n + 10000))
    })
  }
})
