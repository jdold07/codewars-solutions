...
describe("random tests", function () {
  ...
  it("should even() and odd() correctly", function () {
    ...
    assert.deepEqual(
      array.odd().length + array.even().length,
      array.length,
