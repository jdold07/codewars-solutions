...
const {
  balance
} = require("./exclamationMarksSeriesNumber17PutTheExclamationMarksAndQuestionMarksOnTheBalanceAreTheyBalanced")
...
describe("Basic Tests", function () {
  it("It should works for basic tests", function () {
    assert.deepEqual(balance("!!", "??"), "Right")
    assert.deepEqual(balance("!??", "?!!"), "Left")
    assert.deepEqual(balance("!?!!", "?!?"), "Left")
    assert.deepEqual(balance("!!???!????", "??!!?!!!!!!!"), "Balance")
  })
})
