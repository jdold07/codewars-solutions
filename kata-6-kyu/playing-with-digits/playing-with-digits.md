...
##### **Languages Available**: ruby, python, csharp, java, javascript, haskell, clojure, coffeescript, cpp, php, crystal, fsharp, swift, c, typescript, go, shell, ocaml, julia, scala, r, powershell, kotlin, nasm, nim, rust, racket, reason, lua, commonlisp, pascal, perl, raku, elm, d, cobol, prolog, factor
