...
describe("Tests", () => {
  it("test", () => {
    ...
    assert.strictEqual(mazeRunner(mazeMap, ["N", "W", "W", "W", "W"]), "Dead", "Should return Dead")
    assert.strictEqual(
      mazeRunner(mazeMap, ["N", "N", "N", "N", "N", "N", "N", "N", "N", "S", "S", "S", "S", "S", "S", "S", "S", "S"]),
      "Lost",
      "Should return Lost"
    )
    assert.strictEqual(mazeRunner(mazeMap, ["N", "E", "E"]), "Dead", "Should return Dead")
    assert.strictEqual(
      mazeRunner(mazeMap, [
        "N",
        "W",
    ...
    assert.strictEqual(mazeRunner(mazeMap, ["N", "W", "W", "W", "N", "N"]), "Lost", "Should return Lost")
    assert.strictEqual(mazeRunner(mazeMap, ["N", "N", "N", "E"]), "Lost", "Should return Lost")
    assert.strictEqual(
    ...
    function runTests() {
      for (let tests = 1; tests < 100; tests++) {
        let directions = []
        let maze = []
        ...
        assert.strictEqual(mazeRunner(maze, directions), solution, "Expected outcome to be " + solution)
      }
    }
