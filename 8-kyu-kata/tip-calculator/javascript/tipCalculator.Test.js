...
describe("calculateTip", function () {
  ...
  it("should work with random amounts", function () {
    ...
    Test.assertEquals(calculateTip(medRandomNum, "good"), answer(medRandomNum, 0.1))
    Test.assertEquals(calculateTip(smallRandomNum, "excellent"), answer(smallRandomNum, 0.2))
  })
})
