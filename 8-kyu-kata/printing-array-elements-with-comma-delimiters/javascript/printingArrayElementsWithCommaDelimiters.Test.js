...
describe("Tests", () => {
  it("test", () => {
    data = [2]
    Test.expect(printArray(data) == "2", "single int test failed 2!=" + printArray(data))

    var data = [2, 4, 5, 2]
    Test.expect(printArray(data) == "2,4,5,2", "int test failed 2,4,5,2 !=" + printArray(data))

    data = [2.0, 4.2, 5.1, 2.2]
    Test.expect(printArray(data) == "2,4.2,5.1,2.2", "floats test failed 2,4.2,5.1,2.2 !=" + printArray(data))

    data = ["2", "4", "5", "2"]
    Test.expect(printArray(data) == "2,4,5,2", "String test failed 2,4,5,2" + printArray(data))
    ...
    var y = false
    data = [x, y]
    Test.expect(printArray(data) == "true,false", "boolean test failed true,false" + printArray(data))
