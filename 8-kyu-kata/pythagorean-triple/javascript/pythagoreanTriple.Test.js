...
const testCases = [
    ...
    [10, 24, 26], [12, 16, 20], [12, 16, 20], [14, 48, 50], [15, 20, 25], [15, 36, 39],
    [16, 30, 34], [18, 24, 30], [20, 21, 29], [21, 28, 35], [24, 32, 40], [27, 36, 45],
    [30, 40, 50], [70, 18, 8], [50, 19, 19], [44, 17, 15], [4, 54, 5], [33, 11, 24],
    [69, 11, 15], [77, 12, 27], [35, 39, 13], [90, 44, 18], [31, 8,22], [22, 30, 7],
    [94, 16, 25], [84, 37, 18], [84, 19, 23], [9, 45, 21], [61, 18, 9], [93, 50, 25],
    [10, 21, 17], [65, 26, 3], [39, 31, 6], [72, 78, 30]
];
...
describe("Random test cases", function() {
  let randomTests = [].concat(...testCases.map(test => {
  ...
  randomTests.forEach((testCase, index) => {
    it(`Testing for [${testCase.join(", ")}]`, function() {
      let expected = referenceSol(testCase);
      assert.strictEqual(isPythagoreanTriple(testCase), expected.result, expected.description);
    });
