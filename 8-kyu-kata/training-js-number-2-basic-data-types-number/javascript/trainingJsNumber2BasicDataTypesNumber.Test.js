...
for (let myjinxini = 0; myjinxini < 25; myjinxini++) {
  ...
  if (equal2() == ans21 || equal2() == ans22 || equal2() == ans23)
    Test.assertSimilar("Random Test" + (myjinxini * 4 + 1) + " Passed!", "Random Test" + (myjinxini * 4 + 1) + " Passed!")
  else Test.assertSimilar("Your function equal2 got a wrong answer, you should solve kata by use v1-v6", "Test Passed")
  if (equal3() == ans3)
    Test.assertSimilar("Random Test" + (myjinxini * 4 + 2) + " Passed!", "Random Test" + (myjinxini * 4 + 2) + " Passed!")
  else Test.assertSimilar("Your function equal3 got a wrong answer, you should solve kata by use v1-v6", "Test Passed")
  if (equal4() == ans4)
    Test.assertSimilar("Random Test" + (myjinxini * 4 + 3) + " Passed!", "Random Test" + (myjinxini * 4 + 3) + " Passed!")
  ...
  if (equal5() == ans51 || equal5() == ans52 || equal5() == ans53 || equal5() == ans54)
    Test.assertSimilar("Random Test" + (myjinxini * 4 + 4) + " Passed!", "Random Test" + (myjinxini * 4 + 4) + " Passed!")
