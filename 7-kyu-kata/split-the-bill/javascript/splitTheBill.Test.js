...
describe("Basic tests", () => {
  Test.assertSimilar(splitTheBill({ A: 20, B: 15, C: 10 }), { A: 5.0, B: 0.0, C: -5.0 })
  Test.assertSimilar(splitTheBill({ A: 40, B: 25, X: 10 }), { A: 15.0, B: 0.0, X: -15.0 })
  Test.assertSimilar(splitTheBill({ A: 40, B: 25, C: 10, D: 153, E: 58 }), { A: -17.2, B: -32.2, C: -47.2, D: 95.8, E: 0.8 })
  Test.assertSimilar(splitTheBill({ A: 475, B: 384, C: 223, D: 111, E: 19 }), {
    A: 232.6,
    B: 141.6,
    C: -19.4,
    D: -131.4,
  ...
  Test.assertSimilar(splitTheBill({ A: 20348, B: 493045, C: 2948, D: 139847, E: 48937534, F: 1938724, G: 4, H: 2084 }), {
    A: -6421468.75,
    B: -5948771.75,
    C: -6438868.75,
    D: -6301969.75,
