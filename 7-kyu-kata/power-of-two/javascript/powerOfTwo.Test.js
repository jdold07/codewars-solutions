...
describe("isPowerOfTwo", () => {
  ...
  it("Powers of 2", () => {
    ...
    for (const n of ns) Test.assertEquals(isPowerOfTwo(n), true, n + " is a power of 2")
  })
  it("Non-powers of 2", () => {
    const ns = [0, 3, 5, 7, 127, 234, rnd() + 4, rnd() + 3, rnd() - 4, rnd() - 5]
    for (const n of ns) Test.assertEquals(isPowerOfTwo(n), false, n + " is NOT a power of 2")
  })
  it("Random tests", () => {
    for (let i = 0; i < 50; i++) {
