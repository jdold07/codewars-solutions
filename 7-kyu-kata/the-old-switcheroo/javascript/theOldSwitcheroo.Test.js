...
describe('Random Tests', function () {
    ...
    function sol(str) {
        return str.replace(/[aeiou]/gi, function (v, i) { return ++i; });
    }
    ...
    while (--times >= 0) {
        ...
        Test.assertEquals(vowel2index(s1), sol(s1));
    }
