...
describe("Code Length Check And Simple Anti-cheat Tests", function () {
  it("Code length should less than 39 characters.", function () {
    ...
    if (codelen >= limit)
      Test.assertEquals("code length >= " + limit, "code length < " + limit, "your code length = " + codelen)
    else
      Test.assertEquals(
    ...
    if (code.indexOf("prototype") > -1)
      Test.assertEquals("cheater?", "trainer", "Your code should not modify the prototype ;-)")
