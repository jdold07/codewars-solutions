...
describe("Tests", () => {
  it("test", () => {
    ...
    Test.assertDeepEquals(removeRotten(["apple", "banana", "kiwi", "melon", "orange"]), [
      "apple",
      "banana",
      "kiwi",
      "melon",
    ...
    Test.assertDeepEquals(removeRotten(["rottenApple", "rottenBanana", "rottenApple", "rottenPineapple", "rottenKiwi"]), [
      "apple",
      "banana",
      "apple",
      "pineapple",
    ...
    Test.assertDeepEquals(removeRotten(["apple", "rottenBanana", "rottenApple", "pineapple", "kiwi"]), [
      "apple",
      "banana",
      "apple",
      "pineapple",
