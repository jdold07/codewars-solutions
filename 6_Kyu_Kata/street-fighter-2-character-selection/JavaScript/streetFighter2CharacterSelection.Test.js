// [object Object] - Street Fighter 2 - Character Selection  [ ID: 5853213063adbd1b9b0000be  (street-fighter-2-character-selection) ]
...
describe("Testing...", function(){
  ...
  it("should work", function(){
    ...
    const exp = [ 'E.Honda', 'Blanka', 'Guile', 'Balrog', 'Vega', 'M.Bison', 'Sagat', 'Sagat', 'Sagat', 'Balrog', 'Sagat', 'Balrog', 'Guile', 'Balrog', 'Vega', 'Vega' ]
    console.log(exp);
