# [object Object] - Simple Fun #217: Sort By Guide  [ ID: 590148d79097384be600001e  (simple-fun-number-217-sort-by-guide) ]
# URL: https://www.codewars.com/kata/590148d79097384be600001e
# Category: REFERENCE  |  Tags: ALGORITHMS | ARRAYS | SORTING
# ******************************************************************************
import codewars_test as test
from solution import sort_by_guide

@test.describe("Fixed tests")
def fixed_tests():
    @test.it("Tests")
    def it_1():
        test.assert_equals(sort_by_guide([56, 78, 3, 45, 4, 66, 2, 2, 4], [3, 1, -1, -1, 2, -1, 4, -1, 5]), [78, 4, 3, 45, 56, 66, 2, 2, 4])
        ...
        test.assert_equals(sort_by_guide([700, 800, 400, 100, 900, 325], [2, -1, 1, -1, 3, -1]), [400, 800, 700, 100, 900, 325])
        test.assert_equals(sort_by_guide([70, 10, 15, 800, 400, 4, 225, 438, 509, 1000], [6, 1, 4, -1, -1, 2, -1, -1, 5, 3]), [10, 4, 1000, 800, 400, 15, 225, 438, 509, 70])
