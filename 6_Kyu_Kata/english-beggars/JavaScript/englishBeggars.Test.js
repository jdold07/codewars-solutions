// [object Object] - English beggars  [ ID: 59590976838112bfea0000fa  (english-beggars) ]
...
const sol=(v,n)=>v.reduce((a,b,i)=>{a[i%n]+=b; return a;},[...Array(n)].map(e=>0));

for (let q=0;q<40;q++){
  const v=[...Array(randint(3,40))].map(_=>randint(1,Math.pow(10,randint(1,3)))),n=randint(1,20);
