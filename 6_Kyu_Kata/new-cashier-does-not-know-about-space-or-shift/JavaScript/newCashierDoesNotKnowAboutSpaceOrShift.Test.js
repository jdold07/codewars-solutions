// [object Object] - New Cashier Does Not Know About Space or Shift   [ ID: 5d23d89906f92a00267bb83d  (new-cashier-does-not-know-about-space-or-shift) ]
...
describe("Solution", function() {
  it("Fixed Tests", function() {
    ...
    Test.assertEquals(getOrder("burgerfriesfriesfriesfriesfriespizzasandwichcokefriesburger"),
  ...
  it("Random Tests", function() {
    ...
    const generateRandomInput = (n) =>
      Array(n).fill().map(_ => menu[Math.random() * menu.length | 0]).join('').toLowerCase();
