// [object Object] - +1 Array  [ ID: 5514e5b77e6b2f38e0000ca9  (plus-1-array) ]
...
describe("Fixed tests",function(){
  ...
  it("'Big' arrays", function(){
    Test.assertSimilar(upArray([9,2,2,3,3,7,2,0,3,6,8,5,4,7,7,5,8,0,7]), [9,2,2,3,3,7,2,0,3,6,8,5,4,7,7,5,8,0,8]);
    Test.assertSimilar(upArray([9,2,2,3,3,7,2,0,3,6,8,5,4,7,7,5,8,0,7,5,3,2,6,7,8,4,2,4,2,6,7,8,7,4,5,2,1]), [9,2,2,3,3,7,2,0,3,6,8,5,4,7,7,5,8,0,7,5,3,2,6,7,8,4,2,4,2,6,7,8,7,4,5,2,2]);
  });
});

describe("Random tests",function(){
  it("Random arrays", function(){
    let rnd = function(){ return (9+~~(Math.random()*1e7))*~~(Math.random()*1e7) }, arr = function(n){ return (''+n).split('').map(Number) };
    for(let x=0;x<25;x++){
      let n = rnd(), exp = arr(n--), ask = arr(n), bad = ~~(Math.random()*ask.length), msg;
      if( bad%4 ){
  ...
  it("'Big' random arrays", function(){ 
    let rnd = function(){ return (9+~~(Math.random()*1e7))*~~(Math.random()*1e7) }
    for(let x=0;x<25;x++){  
      let ask = ("" + rnd() + rnd() + rnd()).split("").map(Number), bad = ~~(Math.random()*ask.length), exp, msg;
      if( bad%4 ){
