// [object Object] - Kingdoms Ep1: Jousting  [ ID: 6138ee916cb50f00227648d9  (kingdoms-ep1-jousting) ]
...
describe("Tests suite", function () {
	...
	function mySolution(listField, vKnightLeft, vKnightRight) {
		...
		let line1 = " ".repeat(leftPoint - 2) +
			"$->" +
			" ".repeat(listField[0].length - leftPoint - 1)

		let line2 = " ".repeat(rightPoint) +
			"<-P" +
			" ".repeat(listField[1].length - rightPoint - 3)
