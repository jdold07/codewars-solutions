// [object Object] - Simple Fun #242: Caesar Box Cipher Encoding  [ ID: 590a853a093675b283000008  (simple-fun-number-242-caesar-box-cipher-encoding) ]
// URL: https://www.codewars.com/kata/590a853a093675b283000008
// Category: GAMES  |  Tags: PUZZLES
// *****************************************************************************
function an(s){
  var r=0,len=s.length,sq=Math.floor(Math.sqrt(len))
  for(var n=2; n<=sq; n++)
    if(len%n===0&&encode(encode(s,n),n)===s) 
      r +=2
  if(sq*sq===len) r--
  return r;
...
describe("100 Random Tests --- Testing for correctness of solution", function(){
  it("It should works for random tests.", function(){
    for(var iii=0;iii<100;iii++){
      ...
      console.log("<font face='sans-serif' color='#00cc00' size=3><b></b></font><font face='sans-serif' color='#eeee00' size=3>"+
       "\nmessage = "+JSON.stringify(ddd)
