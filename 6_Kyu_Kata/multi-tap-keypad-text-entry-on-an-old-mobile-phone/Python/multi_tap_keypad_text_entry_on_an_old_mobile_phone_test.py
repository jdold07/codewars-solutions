# [object Object] - Multi-tap Keypad Text Entry on an Old Mobile Phone  [ ID: 54a2e93b22d236498400134b  (multi-tap-keypad-text-entry-on-an-old-mobile-phone) ]
# URL: https://www.codewars.com/kata/54a2e93b22d236498400134b
# Category: REFERENCE  |  Tags: FUNDAMENTALS
# ******************************************************************************
from solution import presses
...
def desc2():
    ...
    keystrokes={' ': 1, '#': 1, '*': 1, '1': 1, '0': 2, '3': 4, '2': 4, '5': 4, '4': 4, '7': 5, '6': 4, '9': 5, '8': 4, 'A': 1, 'C': 3, 'B': 2, 'E': 2, 'D': 1, 'G': 1, 'F': 3, 'I': 3, 'H': 2, 'K': 2, 'J': 1, 'M': 1, 'L': 3, 'O': 3, 'N': 2, 'Q': 2, 'P': 1, 'S': 4, 'R': 3, 'U': 2, 'T': 1, 'W': 1, 'V': 3, 'Y': 3, 'X': 2, 'Z': 4}
    def solmobile(phrase): return sum(map(lambda letter: keystrokes[letter],phrase.upper()))
