// [object Object] - Encryption and decryption--Matrix pair  [ ID: 5827ba50c983ca5d8b000a0d  (encryption-and-decryption-matrix-pair) ]
...
function an(key,str){
  ...
  function enc(a,b){
    var idx1=key.indexOf(a),idx2=key.indexOf(b),
        i1= ~~(idx1/10),j1=idx1%10/2,
        i2= ~~(idx2/10),j2=idx2%10/2
    return idx1==idx2||idx1<0||idx2<0 ? a+b :
           i1==i2||j1==j2             ? b+a :
                                        mat[i1][j2]+mat[i2][j1]
  }
}
...
function rndtest(){
  var all="abcdefghijklmnopqrstuvwxyz".replace(rndcl(),"").match(/.{5}/g).map(x=>x.split(""))
  shuff(all)
