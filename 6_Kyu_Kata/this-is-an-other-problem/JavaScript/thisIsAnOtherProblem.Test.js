// [object Object] - "this" is an other problem  [ ID: 547f1a8d4a437abdf800055c  (this-is-an-other-problem) ]
...
describe('Testing...', function(){
  ...
  it("Some random tests...",function(){
    var ll = ["Kouznyets","Herrero","Fabre","Schmidt","Mfua"], ff = ["Ivan","Juan","Jean","Hans","Jomo"];
    var first$ = "Junji", last$ = "Sumisu", nono = new NamedOne(first$,last$);
    var i = 4+~~(Math.random()*3);
    while( i-- ){
