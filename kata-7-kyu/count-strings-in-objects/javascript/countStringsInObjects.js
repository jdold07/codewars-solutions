...
function strCount2(obj) {
  ...
  for (let objects in obj) {
    if (typeof obj[objects] === "object") {
      for (let objectNested in obj[objects]) {
        if (typeof obj[objects][objectNested] === "object") {
          for (let objectNested2 in obj[objects][objectNested]) {
            if (typeof obj[objects][objectNested][objectNested2] === "object") {
              for (let objectNested3 in obj[objects][objectNested][objectNested2]) {
...
module.exports = { strCount, strCount2 }
