...
const { head, tail, init, last } = require("./headTailInitAndLast")
...
describe("Array methods", function () {
  ...
  for (let i = 1; i < 101; i++) {
    ...
    it("Test number " + String(i) + ": [" + String(subject) + "]", function () {
      const [h, t, j, l] = [subject[0], subject.slice(1), subject.slice(0, subject.length - 1), subject[subject.length - 1]]
