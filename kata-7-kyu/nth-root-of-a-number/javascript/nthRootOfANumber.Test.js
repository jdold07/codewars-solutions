//+ ====================================================================================================================
//+
//+ 7 kyu - Nth Root of a Number  [ ID: 5520714decb43308ea000083 ] (nth-root-of-a-number)
...
describe("root", function () {
  let assertFuzzyEquals = function (actual, expected, msg) {
    ...
    expect(inrange, msg || "Expected value near " + expected.toExponential(13) + ", but got " + actual.toExponential(13))
  }
  for (let i = 0; i < 50; i++) {
    let x = random(4, 1e20)
    let n = random(4, 50)
