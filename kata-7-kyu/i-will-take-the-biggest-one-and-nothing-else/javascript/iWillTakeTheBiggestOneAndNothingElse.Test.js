//+ ====================================================================================================================
//+
//+ 7 kyu - I Will  Take the Biggest One and Nothing Else.  [ ID: 631082840289bf000e95a334 ] (i-will-take-the-biggest-one-and-nothing-else)
...
const { maxIntChain } = require("./iWillTakeTheBiggestOneAndNothingElse")
...
describe("Random Test", function () {
  ...
  it("Random Test Cases", function () {
    ;[...Array(100)].forEach(() => doTest(20, 1000))
    ;[...Array(100)].forEach(() => doTest(1000, 100000))
    ;[...Array(100)].forEach(() => doTest(100000, 94906265))
  })
})
