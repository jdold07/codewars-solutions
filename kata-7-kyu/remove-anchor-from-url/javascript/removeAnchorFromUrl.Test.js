...
const { removeUrlAnchor } = require("./removeAnchorFromUrl")
...
describe("Random tests", () => {
  ...
  for (let i = 0; i < 100; i++) {
    let word =
      protos[randint(0, protos.length - 1)] +
      names[randint(0, names.length - 1)] +
      toplds[randint(0, toplds.length - 1)] +
      frags[randint(0, frags.length - 1)]
