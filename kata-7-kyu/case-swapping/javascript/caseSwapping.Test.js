...
const { swap } = require("./caseSwapping")
...
describe("Basic tests", () => {
  ...
  it(`Testing for "ThIs iS A l0NG sENTence witH nUMbERs in IT 123 456"`, () =>
    assert.strictEqual(
      swap("ThIs iS A l0NG sENTence witH nUMbERs in IT 123 456"),
