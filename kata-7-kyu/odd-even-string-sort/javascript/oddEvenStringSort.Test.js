...
const { sortMyString } = require("./oddEvenStringSort")
...
describe("Other Tests", function () {
  it("Static Ones", function () {
    ...
    assert.strictEqual(
      sortMyString("METHIONYLTHREONYLTHREONYGLUTAMINYLARGINYL"),
      "MTINLHENLHENGUAIYAGNL EHOYTROYTROYLTMNLRIY"
    )
    assert.strictEqual(
      sortMyString("PNEUMONOULTRAMICROSCOPICSILICOVOLCANOCONIOSIS"),
