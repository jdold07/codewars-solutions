...
describe("Decoding..", function () {
  it("Basic Tests", function () {
    assert.strictEqual(decode([20, 12, 18, 30, 21], 1939), "scout")
    assert.strictEqual(decode([14, 10, 22, 29, 6, 27, 19, 18, 6, 12, 8], 1939), "masterpiece")
  })
  ...
  it("Random Tests", function () {
    ...
    while (loop < 50000) {
      let str = makeStr()
      let cd = e(str, loop + 2)
      assert.strictEqual(decode(cd, loop + 2), str)
      loop += 123
    }
  })
})
