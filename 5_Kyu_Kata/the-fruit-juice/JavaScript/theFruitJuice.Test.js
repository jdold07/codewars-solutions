// [object Object] - The Fruit Juice  [ ID: 5264603df227072e6500006d  (the-fruit-juice) ]
...
describe('advanced tests', function() {
  ...
  it('pour out juice', function() {
    ...
    assert.strictEqual(jar.getConcentration('apple'), 0, 'After pouring out all the juice, the concentration must be 0 again');
  });
