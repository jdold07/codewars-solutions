// [object Object] - Caesar Cipher Sorting  [ ID: 5483b69b48cf540cfc000119  (caesar-cipher-sorting) ]
...
const caesarSort = (arr) => {
    ...
    return [...Object.values(arr.reduce((a, c) => 
      ({...a, [range.map((v) => cipher(c, v)).sort()]: (a[range.map((v) => cipher(c, v)).sort()] || []).concat(c)}),{}))]
  }
