// [object Object] - What's a Perfect Power  anyway?  [ ID: 54d4c8b08776e4ad92000835  (whats-a-perfect-power-anyway) ]
...
describe("perfect powers", function(){
  it("should work for some examples",function(){
    ...
    Test.assertEquals(isPP(5), null, "5 isn't a perfect power");
  });
  ...
  it("should work for random inputs", function(){
    var solution = function(n){
      var primes = [], i, j, g = 0, gcd = function(a,b){
    ...
    for(i = 0; i < 100; ++i){      
      ...
      if(r !== null)
        k = Math.pow(r[0],r[1]);
      if(r === null && s !== null){
        Test.expect(r !== null, "returned null on perfect power " + l);
        break;
      } else if (r !== null && s === null) {
        Test.expect(r === null, "returned not null on non-perfect power " + l);
        break;
      } else if (r !== null && k !== l) {
        Test.assertEquals(
          k, l, "your pair (" + r[0] + ", "+ r[1]+ ") doesn't work for "+ l);
        break;
      }
    }    
  });
