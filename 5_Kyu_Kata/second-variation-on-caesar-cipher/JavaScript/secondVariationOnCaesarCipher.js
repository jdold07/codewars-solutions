// [object Object] - Second Variation on Caesar Cipher  [ ID: 55084d3898b323f0aa000546  (second-variation-on-caesar-cipher) ]
...
const encodeStr = (s, n) => {
    const s2 =
      ...
      s.replace(/[a-z]/gi, (v) => String.fromCharCode((x = v.charCodeAt()) > 96 ? ((x - 97 + n) % 26) + 97 : ((x - 65 + n) % 26) + 65))
...
const encodeStr = (s, n) => {
  ...
  const decode = (arr) => {
    ...
    return arr
      .join("")
      .slice(2)
      .replace(/[a-z]/gi, (v) => String.fromCharCode((x = v.charCodeAt()) > 96 ? ((x - 97 - n) % 26) + 97 : ((x - 65 - n) % 26) + 65))
  }
