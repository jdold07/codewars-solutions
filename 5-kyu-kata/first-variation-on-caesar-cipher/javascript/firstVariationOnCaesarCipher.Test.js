...
describe("Tests", () => {
  it("test", () => {
    ...
    Test.assertSimilar(movingShift(" uoxIirmoveNreefckgieaoiEcooqo", 2), [" xscOp", "zvygqA", "ftuwud", "adaxmh", "Edqrut"])
    Test.assertSimilar(movingShift("uaoQop jx eh osr okaKv vzagzwpxagokBKriipmc U", 2), [
      "wdsVuw sh",
      " qu dii h",
      "evGs uzbi",
      "caudhoxuM",
    ...
    Test.assertSimilar(movingShift("kgpiqislyhvmffdzlyehjiIteAaaotcoapk bbMgaHlda", 2), [
      "mjtnwpaui",
      "shztutqdr",
      "ycffGseBc",
      "dsyiviyu ",
    ...
    Test.assertSimilar(movingShift("abcdefghjuty", 1), ["bdf", "hjl", "nps", "eek", ""])
    Test.assertSimilar(movingShift("abcdefghjuty1234", 1), ["bdfh", "jlnp", "seek", "1234", ""])
