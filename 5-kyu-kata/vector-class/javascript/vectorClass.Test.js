...
describe("Testing arithmetic", function () {
  it("Addition", function () {
    ...
    Test.expectError("Adding vectors with different lengths should throw an error.", function () {
      c.add(a)
      a.add(c)
    })
  })
  it("Subtraction", function () {
    ...
    Test.expectError("Subtracting vectors with different lengths should throw an error.", function () {
      c.subtract(a)
      a.subtract(c)
    })
  })
  it("Dot Product", function () {
    ...
    Test.expectError("Dotting vectors with different lengths should throw an error.", function () {
      c.dot(a)
      a.dot(c)
    })
  })
